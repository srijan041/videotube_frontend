        ...
        <section className=" w-full sm:px-5 p-2 flex sm:flex-row flex-col items-start sm:gap-4">
          ...
          <div className="w-full md:h-24 sm:h-20 flex justify-between items-start px-1">
            ...
            {user == userProfile && !edit && (
              <Link to={"/edit"}>
                <Button className="border-slate-500 hover:scale-110 transition-all text-black font-bold px-4 py-1 bg-blue-500">
                  Edit
                </Button>
              </Link>
            )}
            {user != userProfile && !edit && (
              <Button
                ...
                className="border-slate-500 hover:scale-110 transition-all text-black font-bold px-4 py-1 bg-blue-500"
              >
